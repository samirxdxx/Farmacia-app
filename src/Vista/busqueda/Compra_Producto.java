...
public class Compra_Producto extends javax.swing.JDialog {
    ...
    public Compra_Producto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tblDetalle.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent Mouse_evt) {
                if (Mouse_evt.getClickCount() == 2) {
                    ...
                    frmCompra.lblIdProducto.setText(id);
                    frmCompra.lblcntProducto.setText("1");
                    valor = 1;
                    dispose();
                }
            }
...
//                        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Compra_Producto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Compra_Producto dialog = new Compra_Producto(new javax.swing.JFrame(), true);
